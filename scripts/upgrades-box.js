//manual way to show exactly the function were calling to upgrade
// to update our contract
...
async function main() {
    ...
    const upgradeTx = await boxProxyAdmin.upgrade(transparentProxy.address, boxV2.address) //upgrade from transp to boxV2
